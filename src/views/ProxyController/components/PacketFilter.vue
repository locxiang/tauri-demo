...
<template>
  <div class="bg-gradient-to-br from-slate-900/60 to-slate-800/40 backdrop-blur-lg border border-blue-500/10 rounded-lg p-4">
    <!-- 过滤器标题和开关 -->
    <div class="flex items-center justify-between mb-4">
      ...
      <div class="flex items-center gap-3">
        ...
        <button
          ...
          class="flex items-center gap-1 px-3 py-1.5 bg-red-500/20 border border-red-500/30 rounded-md text-sm text-red-300 hover:bg-red-500/30 transition-all duration-300"
        >
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
      ...
      <div class="space-y-2">
        ...
        <input
          ...
          class="w-full px-3 py-2 bg-slate-900/60 border border-blue-500/30 rounded-md text-slate-200 text-sm focus:outline-none focus:border-blue-500/60 focus:ring-1 focus:ring-blue-500/20 placeholder-slate-500"
        />
      </div>
    ...
    <!-- 过滤结果统计 -->
    <div v-if="proxyStore.filters.enabled" class="mt-4 pt-4 border-t border-blue-500/20">
